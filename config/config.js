...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\Bollywoodcoin\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/Bollywoodcoin/';
  if (isLinux) dataDir = process.env.HOME + '/.bollywoodcoin/';
}
